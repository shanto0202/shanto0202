...
I am currently focused on strengthening my computer science foundations while developing the ability to design, implement, test, and deploy reliable software systems.
...
* **Junior Astronaut Mission Trainer** — NASA Space Apps Challenge 2026
  Interactive educational simulation focused on lunar/Martian outpost management, resource allocation, and engineering trade-offs.

* **AI-Assisted Energy Optimization System** — BUP CSE Fest 2026
  Optimization API combining LLM-based instruction processing, deterministic validation, linear programming, and automated testing.

* **ACADEMICS** — BUET Undergraduate Repository
  Organized collection of coursework, assignments, implementations, and laboratory work from my BUET undergraduate studies.

* **pdfshelf** — Personal Project
  Mobile-friendly PDF distribution system with administrator-managed accounts, single-session authentication, watermarking, and browser-based reading.

* **Kickoff — 2D Football Game** — IUT 12th ICT Fest 2026
